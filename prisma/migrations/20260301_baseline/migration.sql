-- CreateEnum
CREATE TYPE "TipoEspacio" AS ENUM ('AULA', 'AREA_COMUN');
...
CREATE TABLE "espacios" (
    ...
    CONSTRAINT "espacios_pkey" PRIMARY KEY ("idEspacio")
);
...
CREATE TABLE "grupos" (
    ...
    "activo" BOOLEAN NOT NULL DEFAULT true,
    "docenteTutorId" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "administrativos_usuarioId_key" ON "administrativos"("usuarioId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "docentes_usuarioId_key" ON "docentes"("usuarioId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "espacios_nombre_key" ON "espacios"("nombre" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "estudiantes_matricula_key" ON "estudiantes"("matricula" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "estudiantes_tokenPadre_key" ON "estudiantes"("tokenPadre" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "estudiantes_usuarioId_key" ON "estudiantes"("usuarioId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "usuarios_curp_key" ON "usuarios"("curp" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "usuarios_email_key" ON "usuarios"("email" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "usuarios_username_key" ON "usuarios"("username" ASC);
...
-- AddForeignKey
ALTER TABLE "grupos" ADD CONSTRAINT "grupos_docenteTutorId_fkey" FOREIGN KEY ("docenteTutorId") REFERENCES "docentes"("idDocente") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "materias" ADD CONSTRAINT "materias_espacioId_fkey" FOREIGN KEY ("espacioId") REFERENCES "espacios"("idEspacio") ON DELETE SET NULL ON UPDATE CASCADE;
